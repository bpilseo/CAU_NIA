...
def train(hyp, opt, device, tb_writer=None):
    ...
    for k, v in model.named_parameters(): # k: name, v:param
        v.requires_grad = True  # 여기 수정

#         print('name: ', k)
#         # print(type(v))
#         # print('param.shape: ', v.shape)
#         # print('param.requires_grad: ', v.requires_grad)
#         # print('=====')

# ########################
#         if k in ['0.conv.weight', '0.bn.weight', '0.bn.bias']:
